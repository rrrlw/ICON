...
However, the S3 generic `as.network.ICON` is provided to permit use of the network and ggnetwork R packages for analysis and visualization, respectively.
